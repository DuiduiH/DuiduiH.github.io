...
window.MODULE_DATA = {
  ...
  hobbies: [
    ...
    {n:'公路车',en:'Road Bike',c:'sports',img:'roadbike',d:'风在耳边呼啸，速度就是自由',dEn:'Wind howling past my ears — speed is freedom',i:'M15.5 5.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zM5 12c-2.8 0-5 2.2-5 5s2.2 5 5 5 5-2.2 5-5-2.2-5-5-5zm0 8.5c-1.9 0-3.5-1.6-3.5-3.5s1.6-3.5 3.5-3.5 3.5 1.6 3.5 3.5-1.6 3.5-3.5 3.5zM19 12c-2.8 0-5 2.2-5 5s2.2 5 5 5 5-2.2 5-5-2.2-5-5-5zm0 8.5c-1.9 0-3.5-1.6-3.5-3.5s1.6-3.5 3.5-3.5 3.5 1.6 3.5 3.5-1.6 3.5-3.5 3.5zM10.9 8.6l2.1 2v4.9h-2V12l-3.8-3.2L10.9 8.6z'},
    {n:'Gravel',en:'Gravel',c:'sports',img:'gravel',d:'越野碎石路才是真正的冒险',dEn:'Off-road gravel is the real adventure',i:'M13.5 5.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zM4 17c-2.2 0-4 1.8-4 4h2c0-1.1.9-2 2-2s2 .9 2 2h2c0-2.2-1.8-4-4-4zm16 0c-2.2 0-4 1.8-4 4h2c0-1.1.9-2 2-2s2 .9 2 2h2c0-2.2-1.8-4-4-4zM12.6 9L8 13h3.3l-1.8 5h2.2l5-7h-3.5l1.4-2z'},
    {n:'马拉松',en:'Marathon',c:'sports',img:'marathon',d:'42.195公里，和自己的一场对话',dEn:'42.195 km, a conversation with myself',i:'M13.5 5.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zM9.8 8.9L7 23h2.1l1.8-8 2.1 2v6h2v-7.5l-2.1-2 .6-2.8C15 12.8 17 14 19.5 14v-2c-2 0-3.7-1-4.5-2.5l-1-1.7c-.4-.6-1-1-1.7-1-.3 0-.5.1-.8.1L7 8.8V13h2V9.6l.8-.7z'},
    {n:'游泳',en:'Swimming',c:'sports',img:'swimming',d:'水里的世界安静又自由',dEn:'The underwater world is quiet and free',i:'M22 21c-1.1 0-1.7-.4-2.2-.8-.4-.3-.7-.5-1-.5s-.6.2-1 .5c-.5.4-1.1.8-2.2.8s-1.7-.4-2.2-.8c-.4-.3-.7-.5-1-.5s-.6.2-1 .5c-.5.4-1.1.8-2.2.8s-1.7-.4-2.2-.8c-.4-.3-.7-.5-1-.5s-.6.2-1 .5c-.5.4-1.1.8-2.2.8v-2c.3 0 .6-.2 1-.5.5-.4 1.1-.8 2.2-.8s1.7.4 2.2.8c.4.3.7.5 1 .5s.6-.2 1-.5c.5-.4 1.1-.8 2.2-.8s1.7.4 2.2.8c.4.3.7.5 1 .5s.6-.2 1-.5c.5-.4 1.1-.8 2.2-.8s1.7.4 2.2.8c.4.3.7.5 1 .5v2zM22 16.4c-1.1 0-1.7-.4-2.2-.8-.4-.3-.7-.5-1-.5s-.6.2-1 .5c-.5.4-1.1.8-2.2.8s-1.7-.4-2.2-.8c-.4-.3-.7-.5-1-.5s-.6.2-1 .5c-.5.4-1.1.8-2.2.8V14l5.5-3.4a2 2 0 0 0 .3-2.9l-2.5-3-.6 3.4L10 10V6.5l3.5-1c.5-.1.9-.5 1-1l.4-2.3c-.9.1-1.7.6-2.1 1.3L10 7.4 7 9v5.6c.8 0 1.5.3 2 .7.4.3.7.5 1 .5s.6-.2 1-.5c.5-.4 1.1-.8 2.2-.8s1.7.4 2.2.8c.4.3.7.5 1 .5s.6-.2 1-.5c.5-.4 1.1-.8 2.2-.8s1.7.4 2.2.8c.4.3.7.5 1 .5v2z'},
    {n:'徒步',en:'Hiking',c:'sports',img:'hiking',d:'用脚步丈量世界的每一寸土地',dEn:'Measuring every inch of the world on foot',i:'M13.5 5.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zM9.8 8.9L7 23h2.1l1.8-8 2.1 2v6h2v-7.5l-2.1-2 .6-2.8C15 12.8 17 14 19.5 14v-2c-2 0-3.7-1-4.5-2.5l-1-1.7c-.4-.6-1-1-1.7-1-.3 0-.5.1-.8.1L7 8.8V13h2V9.6l.8-.7z'},
    {n:'旅行',en:'Travel',c:'experience',img:'travel',d:'背上包就出发，世界那么大',dEn:'Pack up and go — the world is so big',i:'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z'},
    {n:'摄影',en:'Photo',c:'experience',img:'photo',d:'想买相机ing，先用手机记录每一刻',dEn:'Saving up for a camera, capturing moments with my phone for now',i:'M12 10.8a3.2 3.2 0 1 0 0 6.4 3.2 3.2 0 0 0 0-6.4zM9 2L7.17 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2h-3.17L15 2H9zm3 15c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5z'},
